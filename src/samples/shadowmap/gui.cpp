...
void SimpleShadowmapRender::SetupGUIElements()
{
  ...
  ImGui::NewFrame();
  {
    ...
    ImGui::Checkbox("Indirect light", (bool *)&m_uniforms.useIndirectLighting);

    ImGui::Checkbox("Tonemap", (bool *)&tonemapParams.tonemapEnabled);
    ImGui::SliderFloat("Light intensity", &m_uniforms.lightIntensity, 0.0f, 10.f);
    const char *items[] = { "Hill", "Narkowicz" };

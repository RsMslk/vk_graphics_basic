...
{
  etna::create_program("rsm_setup", { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/simple.vert.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/rsm_setup.frag.spv" });
  etna::create_program("indirect_light", { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/simple_quad.vert.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/indirect_light.frag.spv" });
  ...
  etna::create_program("tonemap", { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/simple_quad.vert.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/tonemap.frag.spv" });
}
...
void SimpleShadowmapRender::SetupSimplePipeline()
{
  ...
  m_geometryPipeline = pipelineManager.createGraphicsPipeline("simple_geometry",
    { .vertexShaderInput = sceneVertexInputDesc,
      .blendingConfig    = {
           .attachments = { blendState, blendState, blendState } },
      .fragmentShaderOutput = { .colorAttachmentFormats = { vk::Format::eR8G8B8A8Srgb, vk::Format::eR32G32B32A32Sfloat, vk::Format::eR32G32B32A32Sfloat }, .depthAttachmentFormat = vk::Format::eD16Unorm } });
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  if (m_uniforms.useIndirectLighting)
  {
    ...
    //
    {
      ...
      vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_GRAPHICS, m_indirectPipeline.getVkPipelineLayout(), 0, 1, &vkSet, 0, VK_NULL_HANDLE);
  ...
  //
  {
    ...
    auto set = etna::create_descriptor_set(tonemapInfo.getDescriptorLayoutId(0), a_cmdBuff, { etna::Binding{ 0, hdrImage.genBinding(defaultSampler.get(), vk::ImageLayout::eShaderReadOnlyOptimal) } });
    ...
    vkCmdPushConstants(a_cmdBuff, m_tonemapPipeline.getVkPipelineLayout(), VK_SHADER_STAGE_FRAGMENT_BIT, 0, sizeof(tonemapParams), &tonemapParams);
